...
# Review note: переместить эти константы в класс или модуль, который относится к tickets
...
class Config(object):
    ...
    CSRF_ENABLED = True
    # Review note:
    # Рекомендуется хранить credentials в переменной окружения или в защищенном файле конфигурации,
